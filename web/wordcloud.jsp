...
<%@ page import="org.apache.struts2.dojo.components.Tree" %>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-8">
                        <div class="pricing-box-item  mb-30">
                            <canvas id="can1" width="375px" height="520px"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-8">
                        <div class="pricing-box-item  mb-30">
                            <canvas id="can2" width="375px" height="520px"></canvas>
                        </div>
                    </div>
                    <script>
                        //api https://wordcloud2-js.timdream.org/#web-tech
                        var wordFreqData1 = [
                            <%
                                TreeMap<String,Integer> mp1 = (TreeMap<String, Integer>) request.getSession().getAttribute("genre");
                        ...
                        var wordFreqData2 = [
                            <%
                                TreeMap<String,Integer> mp2 = (TreeMap<String, Integer>) request.getSession().getAttribute("actor");
                                 iterator = mp2.entrySet().iterator();
                                while(iterator.hasNext()){
                                    Map.Entry entry = (Map.Entry) iterator.next();
                                    String key = (String)entry.getKey();
                                    Integer it = (Integer) entry.getValue();
                        ...
                        var options1 = eval({
                            ...
                            "backgroundColor": '#1F1E24', // 背景颜色
                            "rotateRatio": 0.5, // 字体倾斜(旋转)概率，1代表总是倾斜(旋转)
                            "click": function (item) {
                                console.log('this is click:' + item[0] + ':' + item[1]);
                            }
                        });
                        var options2 = eval({
                            "list": wordFreqData2,
                        ...
                        //生成
                        WordCloud(canvas1, options1);
                        WordCloud(canvas2, options2);
                    </script>
                </div>
            </div>
        </div>
