...
<main>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2 class="title">用户词云</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.jsp">首页</a></li>
                                <li class="breadcrumb-item active" aria-current="page">用户词云</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <!-- pricing-area -->
    <section class="pricing-area pricing-bg" data-background="css_lib/img/bg/pricing_bg.jpg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title title-style-three text-center mb-70">
                        <span class="sub-title">你的用户画像</span>
                        <h2 class="title">观影历史词云</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <script>
                        onload = function () {
                            var data1 = {
                                value: [
                                    <%
                                        ...
                                        TreeMap<String,Integer> genre = (TreeMap<String, Integer>) request.getAttribute("genre");
                                        Set<String> genrekeys = genre.keySet();
                            ...
                            var data2 = {
                                value: [
                                    <%
                                        ...
                                        TreeMap<String,Integer> actor = (TreeMap<String, Integer>) request.getAttribute("actor");
                                        Set<String> actorkeys = actor.keySet();
                            ...
                            var myChart1 = echarts.init(document.getElementById('genre'));
                            var myChart2 = echarts.init(document.getElementById('actor'));
                            //温馨提示：image 选取有严格要求不可过大；，否则firefox不兼容  iconfont上面的图标可以
                            var maskImage1 = new Image();
                            var maskImage2 = new Image();
                            maskImage1.src = data1.image
                            maskImage2.src = data2.image
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-8">
                        <div class="pricing-box-item  mb-30">
                            <div id="genre" style="width: 375px; height: 520px"></div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-8">
                        <div class="pricing-box-item  mb-30">
                            <div id="actor" style="width: 375px; height: 520px"></div>
                    ...
                    <!--                                <ul>-->
                    <!--                                    <li class="quality"><i class="fas fa-check"></i> Video quality <span>Best</span>-->
                    <!--                                    </li>-->
