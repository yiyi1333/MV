    ...
    <section class="movie-area movie-bg" data-background="css_lib/img/bg/movie_bg.jpg">
        <div class="container">
            <div class="row align-items-end mb-60">
                <div class="col-lg-6">
                    <div class="section-title text-center text-lg-left">
                        <span class="sub-title">TOP 100</span>
                        <h2 class="title">MOVIE RANK</h2>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="movie-page-meta">
                        <div class="tr-movie-menu-active text-center">
                            <button class="active" data-filter=".cat-one">RATE</button>
            ...
            <div class="row tr-movie-active">
                <s:iterator value="#session.ratelist">
                    <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                        <div class="movie-item movie-item-three mb-50">
                            ...
                            <div class="movie-content">
                                ...
                                <div class="bottom">
                                    <ul>
                                        <li><span class="quality">TOP100</span></li>
                                        <li>
